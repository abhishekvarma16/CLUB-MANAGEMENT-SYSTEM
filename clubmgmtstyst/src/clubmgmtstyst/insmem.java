...
public class insmem extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel4.setBounds(40, 220, 150, 32);
   ...
   int cid=Integer.parseInt(jf3.getText());
  if(cid==10||cid==11||cid==12||cid==13){
   pst.setInt(3,Integer.parseInt(jf3.getText()));
   
   pst.execute();
   sucess o=new sucess();}else{
      JOptionPane.showMessageDialog(null, "ERROR,CLUB ID DOES NOT EXIST");
  }
   }catch (Exception ex) {
